...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const navHTML = `
    <nav class="site-nav">
      <div class="container">
        <a href="index.html" class="brand"><span class="brand-mark-wrap"><img src="img/novello-n-monogram.png" alt="" class="brand-mark"><img src="img/novello-n-monogram.png" alt="" class="brand-mark-reflection" aria-hidden="true"></span><span class="brand-wordmark">NOVELLO STONE</span></a>
        <ul class="nav-links">
